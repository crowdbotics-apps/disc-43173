"""
Django settings for disc_43173 project.
...
WSGI_APPLICATION = 'disc_43173.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "disc_43173 API",
    "DESCRIPTION": "API documentation for disc_43173 App",
    "VERSION": "v1",
}
